...
namespace atlas
{
	...
	{
	public:
		Triangle(const Transform &objectToWorld, const Transform &worldToObject, bool reverseOrientation, const std::shared_ptr<TriangleMesh> &mesh, uint32_t triNumber)
